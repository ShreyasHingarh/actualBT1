...
namespace ActualGame
{
    ...
    internal class Vertex
    {
        ...
        public ScreenSquare Value { get; set; }
        ...
        public Vertex(ScreenSquare value)
        {
    ...
    internal class GraphStuff
    {
        ...
        private List<ScreenSquare> verticesValues;
        ...
        public GraphStuff()
        {
            ...
            edges = new List<Edge>();
            verticesValues = new List<ScreenSquare>();
        }
        public void AddVertex(ScreenSquare Value)
        {
        ...
        public int SearchForVertexIndex(ScreenSquare value)
        {
        ...
        public Vertex Search(ScreenSquare value)
        {
            for (int i = 0; i < vertices.Count; i++)
            {
                if (vertices[i].Value.Equals(value))
